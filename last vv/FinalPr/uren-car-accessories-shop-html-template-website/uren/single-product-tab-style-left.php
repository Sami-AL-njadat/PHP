                                ...
                                <div class="sp-img_area">
                                    <div class="sp-img_slider slick-img-slider uren-slick-slider" data-slick-options='{
                                        ...
                                        <div class="single-slide red zoom">
                                            <img src="./skydash/pages/prodacts/<?php echo $product['product_img1'] ?>" alt="Uren's Product Image">
                                        </div>
                                        <div class="single-slide orange zoom">
                                            <img src="./skydash/pages/prodacts/<?php echo $product['product_img2'] ?>" alt="Uren's Product Image">
                                        </div>
                                        <div class="single-slide brown zoom">
                                            <img src="./skydash/pages/prodacts/<?php echo $product['product_img3'] ?>" alt="Uren's Product Image">
                                        </div>
                                        <div class="single-slide umber zoom">
                                            <img src="./skydash/pages/prodacts/<?php echo $product['product_img4'] ?>" alt="Uren's Product Image">
                                        </div>
