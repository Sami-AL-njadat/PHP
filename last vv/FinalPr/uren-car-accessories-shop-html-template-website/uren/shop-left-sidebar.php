                                        ...
                                        <div class="single-product">
                                            <div class="product-img">
                                                ...
                                                <a href="single-product-tab-style-left.php?productId=<?php echo $product['id'] ?>">
                                                    <img class="primary-img" src= "./skydash/pages/prodacts/<?php echo $product['product_img1'] ?>">
                                                    <img class="secondary-img" src="./skydash/pages/prodacts/<?php echo $product['product_img2'] ?>">
                                                </a>
