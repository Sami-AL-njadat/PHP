...
if (mysqli_num_rows($result) > 0)
{
	...
	// C:\xampp\htdocs\PHP\final\FinalPr\uren-car-accessories-shop-html-template-website\uren\add-a-reset-password-option
	$message .= "<a href='http://localhost/PHP/final/FinalPr/uren-car-accessories-shop-html-template-website/uren/add-a-reset-password-option/reset-password.php?email=$email&reset_token=$reset_token'>";
