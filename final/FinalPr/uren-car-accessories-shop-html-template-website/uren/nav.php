...
if (isset($_SESSION['user_id'])) {
    ...
    // $getcounter = mysqli_query($conn, "SELECT *  from category LIMIT 6");
...
<body style="width:100%;" class="template-color-1">
    ...
    <div class="main-wrapper">
        ...
        <header class="header-main_area bg--sapphire">
            ...
            <div class="header-top_area d-lg-block d-none pt-3">
                <!-- ======================== -->
                <div class="container-fluid"> 
                    <div  class="row">
                    <div style="padding-top:20px" class=" col-xl-2 col-lg-2">
                    <!-- class="custom-logo_col col-2  -->
                            <!-- col-12 -->
                            ...
                            <div class="main-menu_area position-relative">
                                <nav class="main-nav">
                                    <ul>
                                        ...
                                        <li class="megamenu-holder "><a href="shop-left-sidebar.php?CataId=1">Shop</a>
                        ...
                        <div style="padding-top:10px" class="col-xl-4 col-lg-4">
                            <div class="ht-right_area">
                                <div class="ht-menu">
                                    <ul style ="justify-content: flex-end;">
                                        ...
                                        ?>
                                            <!-- <li><a href="my-account.html">My Account<i class="fa fa-chevron-down"></i></a>
                                                <ul class="ht-dropdown ht-my_account">
                                                    <li><a href="login1.php">Register</a></li>
                                                    <li class="active"><a href="login1.php">Login</a></li>
                                                </ul>
                                            </li> -->
                                            <div   class="uren-btn-ps_left">
                                        <a style=" height:40px; margin-right:10px; width : 75px!important; font-size:12px " class="uren-btn" href="login1.php">login</a>
                                        </div>
                                            <div   class="uren-btn-ps_left">
                                        <a style="height:40px; width : 75px!important; font-size:12px " class="uren-btn" href="login1.php">Sign Up</a>
                                        </div>
                                        ...
                                        <div   class="uren-btn-ps_left">
                                        <a style="height:40px; margin-right:10px; width : 75px!important; font-size:12px " class="uren-btn" href="myaccount.php">Profile</a>
                                        </div>

                                            <div   class="uren-btn-ps_left">
                                                <form action="" method="post">
                                        <button style="height:40px; width : 75px!important; font-size:12px " class="uren-btn" type="submit" name="submitin">Logout</button>
                                        </form>
                                        </div>
                                        ...
                                        ?>
                                            ...
                                            <?php if( $_SESSION['isLogin'] == 'yes') {
                                                $userid = $_SESSION['user_id'];
                                                $sqln ="SELECT COUNT(*) as record_count FROM cart WHERE user_id = $userid";
                                                ...
                                                if ($resultn) {
                                                    ...
                                                    $record_count = $rown['record_count'];
                                                }
                                                  }else {
                                                    if (isset($_SESSION['arrayOfProduct'])){
                                                        $record_count = count($_SESSION['arrayOfProduct']);
                                                    }else{
                                                        $record_count = 0;
                                                    }
                        ...
                        <div style="padding-top:10px; padding-left:15px; " class="col-xl-2 col-lg-2">
                            <div   class="header-right_area">
                                <ul style ="justify-content: flex-end;     padding-inline-start: 20px !important;">
                                   
                                    <li style="height: 40px; line-height: 40px; margin-right: 30px; padding-left:0px; " class="minicart-wrap">
                                        <a  class= 'minicart-btn' href="cart.php" >
                                            <div class="minicart-count_area">
                                                <span class="item-count"><?php echo $record_count ?></span>
                                                <i class="ion-bag"></i>
                                            </div>
            ...
            <div class="header-top_area header-sticky bg--sapphire">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class=" col-sm-1 col-xl-10 col-lg-10 d-lg-block d-none">
                            <div class="main-menu_area position-relative">
                                <nav class="main-nav">
                                    <ul>
                                        <li class="dropdown-holder active"><a href="Home.php">Home</a>
