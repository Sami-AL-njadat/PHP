    ...
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            <form action="signup-code.php" method="POST">
                ...
                <br>
                <input id="firstname" type="text" placeholder="first name : for example Amani" name="first_name" />
                <br>
                <input id="lastname" type="text" placeholder="last name : for example Faris" name="last_name" />
                <br>
                <input type="email" placeholder="Email : example@email.com" name="email" />

                <br>
                <input type="password" placeholder="Password : SecureP@ss123" name="passwords" />
                <p>
